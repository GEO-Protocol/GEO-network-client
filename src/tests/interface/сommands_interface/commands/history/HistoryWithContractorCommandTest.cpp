...
TEST_CASE("Testing HistoryWithContractorCommand")
{
    ...
    command = new HistoryWithContractorCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,"0\t1\t1\t12\t127.0.0.1:2007\t2\n");
    ...
    SECTION("Character instead of space")
    {
    ...
    SECTION("Character instead of dot in address")
    {
    ...
    SECTION("Character instead of colon in address")
    {
    ...
    SECTION("Character instead of port")
    {
