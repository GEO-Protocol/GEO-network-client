...
TEST_CASE("Testing HistoryPaymentsCommand")
{
    ...
    command = new HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s, "1\t2\t3\t4\t5\t6\t47183823-2574-4bfd-b411-99ed177d3e43\t8\n");
    ...
    SECTION("Max number in input")
    {
        ...
        REQUIRE_NOTHROW(HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,
                                                         "1\t2\t3\t4\t340282366920938463463374607431768211456\t6\t47183823-2574-4bfd-b411-99ed177dd3e4\t8\n"));
    }
    ...
    SECTION("Max number in input")
    {
        ...
        REQUIRE_NOTHROW(HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,
                                                         "1\t2\t3\t4\t5\t340282366920938463463374607431768211456\t47183823-2574-4bfd-b411-99ed177de435\t8\n"));
    }
    ...
    SECTION("Overflow in input (40 digits)")
    {
        ...
        REQUIRE_THROWS(HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,
                                                        "1\t2\t3\t4\t3402823669209384634633746074317682114560\t6\t47183823-2574-4bfd-b411-99ed177de43\t8\n"));
    }
    ...
    SECTION("Overflow in input (40 digits)")
    {
        ...
        REQUIRE_THROWS(HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,
                                                        "1\t2\t3\t4\t5\t3402823669209384634633746074317682114560\t47183823-2574-4bfd-b411-99ed177d343\t8\n"));
    }
    ...
    SECTION("Overflow in input (40 digits)")
    {
        ...
        REQUIRE_THROWS(HistoryPaymentsCommand("47183823-2574-4bfd-b411-99ed177d3e43"s,
                                                        "1\t2\t3\t4\t3402823669209384634633746074317682114560\t3402823669209384634633746074317682114560\t47183823-2574-4bfd-b411-99ed17dde463\t8\n"));
    }
