#ifndef GEO_NETWORK_CLIENT_HISTORYPAYMENTSALLEQUIVALENTSCOMMAND_H
#define GEO_NETWORK_CLIENT_HISTORYPAYMENTSALLEQUIVALENTSCOMMAND_H
...
#endif //GEO_NETWORK_CLIENT_HISTORYPAYMENTSALLEQUIVALENTSCOMMAND_H
