#ifndef GEO_NETWORK_CLIENT_OUTGOINGREMOTENODENEW_H
#define GEO_NETWORK_CLIENT_OUTGOINGREMOTENODENEW_H
...
class OutgoingRemoteNodeNew {
public:
    using Shared = shared_ptr<OutgoingRemoteNodeNew>;
    using Unique = unique_ptr<OutgoingRemoteNodeNew>;

public:
    OutgoingRemoteNodeNew(
...
#endif //GEO_NETWORK_CLIENT_OUTGOINGREMOTENODENEW_H
