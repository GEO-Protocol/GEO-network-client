#ifndef GEO_NETWORK_CLIENT_CYCLEBOUNDARYNODETOPOLOGYMESSAGE_H
#define GEO_NETWORK_CLIENT_CYCLEBOUNDARYNODETOPOLOGYMESSAGE_H
...
#endif //GEO_NETWORK_CLIENT_CYCLEBOUNDARYNODETOPOLOGYMESSAGE_H
