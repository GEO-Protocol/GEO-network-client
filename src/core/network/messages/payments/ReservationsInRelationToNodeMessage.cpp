...
//
//        // Direction
//        ReservationDirection *direction = new (bytesBufferOffset)ReservationDirection;
//        bytesBufferOffset += sizeof(ReservationDirection);
//
...
{
    return Message::Payments_ReservationsInRealtionToNode;
}
